...
def download_video_as_mp3(youtube_url, output_folder):
    try:
        ...
        print(f"Downloaded thumbnail to {thumb_path}")  # Debugging statement
        print(f"Checking if audio file exists at {output_path}")  # Debugging statement
        ...
        print(f"Returning filename: {output_path.name}")  # Debugging statement
